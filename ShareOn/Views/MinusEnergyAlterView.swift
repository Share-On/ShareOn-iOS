...
class MinusEnergyAlterView: UIView {
    lazy var energyTf = UITextField().then {
        ...
        $0.textColor = .rgb(red: 70, green: 150, blue: 225)
        $0.addLeftPadding()
    }
    ...
    lazy var okButton = UIButton().then {
        ...
        $0.setTitleColor(.rgb(red: 70, green: 150, blue: 225), for: .normal)
        $0.backgroundColor = .rgb(red: 211, green: 229, blue: 246)
        $0.dynamicFont(fontSize: 11, currentFontName: "AppleSDGothicNeo-Medium")
        $0.layer.cornerRadius = 10
    }
